            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="{{route('companySubmit')}}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="{{old('kode_company')}}" name="kode_company" id="kode_company" maxlength="5" oninput="updateCounter('kode_company', 'charCount_kode_company' , 'maxCount_kode_company')">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" onkeydown="return /[a-zA-Z, ]$/i.test(event.key)" type="text" value="{{old('nama_company')}}" name="nama_company" id="nama_company" maxlength="150" oninput="updateCounter('nama_company', 'charCount_nama_company' , 'maxCount_nama_company')">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select type="text" name="id_business" class="form-control select2bs4" style="width:100% !important;">
                                                ...
                                                <option value="{{$b->id_business}}">{{$b->nama_business}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" onkeydown="return /[a-zA-Z, ]$/i.test(event.key)" type="text" value="{{old('currency_company')}}" name="currency_company" id="currency_company" maxlength="50" oninput="updateCounter('currency_company', 'charCount_currency_company' , 'maxCount_currency_company')">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="{{old('alamat_company')}}" name="alamat_company" id="alamat_company" maxlength="250" oninput="updateCounter('alamat_company', 'charCount_alamat_company' , 'maxCount_alamat_company')">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '')" type="text" value="{{old('telp_company')}}" name="telp_company" id="telp_company" maxlength="20" oninput="updateCounter('telp_company', 'charCount_telp_company' , 'maxCount_telp_company')">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="email" value="{{old('email_company')}}" name="email_company" id="email_company" maxlength="100" oninput="updateCounter('email_company', 'charCount_email_company' , 'maxCount_email_company')">
