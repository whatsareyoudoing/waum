            ...
            <div class="row w-50">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="{{route('businessSubmit')}}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input onkeydown="return /[a-zA-Z, ]$/i.test(event.key)" type="text" class="form-control" value="{{ old('nama_business') }}" name="nama_business" id="nama_business" placeholder="Nama" maxlength="150" oninput="updateCounter('nama_business', 'charCount_nama_business' , 'maxCount_nama_business')">
