                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input onkeydown="return /[a-z,0-9, ]/i.test(event.key)" type="text" class="form-control" value="{{ old('name_application') }}" name="name_application" id="name_application" placeholder="Masukkan Nama" maxlength="150" oninput="updateCounter('name_application', 'charCount_name_application' , 'maxCount_name_application')">
