...
class UpdateMenuRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $id_menu=$this->route()->id;
        return [
            'canread' => ['nullable'],
            'id_application' => ['required'],
            'kode_menu' => 'required|unique:menu,kode_menu,'.$id_menu.',id_menu',
    ...
    {
        return [
            'id_application.required' => 'Nama Aplikasi Wajib diisi',
            'kode_menu.required' => 'Kode Menu Wajib diisi',
            'url_menu.required' => 'URL Menu Wajib diisi',
            'nama_menu.required' => 'Nama Menu Wajib diisi',
            'kode_menu.max' => 'Nama Menu Maksimal :max',
            'url_menu.max' => 'URL Menu Maksimal :max',
            'nama_menu.max' => 'Nama Menu Maksimal :max',
